...
public class NotificationLearningActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
            /*加载页面*/
		setContentView(R.layout.activity_notification_learning);
	...
	private void init() {
		...
		Intent intent = new Intent(this,NotificationLearningActivity.class);

		pd = PendingIntent.getActivity(NotificationLearningActivity.this, 0, intent, 0);
	}
		...
		public void onClick(View v) {
			switch(v.getId()) {
				case R.id.le10bt01:
					...
					//设置通知在状态栏显示的图标
					baseNF.icon = R.mipmap.ic_launcher_wine;
					...
					//第四个参数：点击该通知时执行页面跳转
					baseNF.setLatestEventInfo(NotificationLearningActivity.this, "Title01", "Content01", pd);
				...
				case R.id.le10bt02:
					...
					baseNF.setLatestEventInfo(NotificationLearningActivity.this, "Title02", "Content02", pd);
					nm.notify(Notification_ID_BASE, baseNF);
					break;
				...
				case R.id.le10bt04:
					...
					mediaNF.icon = R.mipmap.ic_launcher_wine;
					...
					mediaNF.setLatestEventInfo(NotificationLearningActivity.this, "Title03", "Content03", pd);
				...
				case R.id.le10bt07:
					...
					notification.icon = R.mipmap.ic_launcher_wine;
					notification.tickerText = "Custom!";

					RemoteViews contentView = new RemoteViews(getPackageName(), R.layout.custom);
					contentView.setImageViewResource(R.id.image, R.mipmap.ic_launcher_wine);
